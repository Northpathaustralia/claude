...
A club located there draws **two catchments at once** — the high-income, wellness-oriented Hope Island/Sanctuary Cove population to the east, and the young, high-participation growth corridor (Helensvale, Oxenford, Coomera, Pimpama) to the west and north — while avoiding a head-on collision with Goodlife inside the two Westfields.

We also tested the honest counter-case ("is Hope Island the wrong location?") in Section 7.

---

## 2. Macro market check (before any site is scored)
...
### 3.1 Primary catchment — Hope Island SA2 (4212)

| Metric | Value | Source |
|---|---|---|
| Population (2021 Census) | 14,665 | ABS QuickStats SAL31356 |
| Population (Feb 2026 est.) | ~18,585 (**+26.7% since 2021** — vs +9.1% rest of QLD) | AreaSearch SA2 309071253 |
| Median household income | **$1,934/week** (≈ $100.6k/yr; well above QLD median ≈ $1,675/wk) | ABS 2021 / AreaSearch |
| Median age | **50** (largest cohort 65–74; ~28% aged 65+; ~18% under 20) | AreaSearch |
...
| Suburb | Character | Signal |
|---|---|---|
| Helensvale | Established family suburb, Westfield, rail + G:link | Mature demand, currently served by Goodlife Helensvale |
| Oxenford | Family suburb, no full-service premium club | Underserved |
| Coomera / Upper Coomera | Westfield Coomera, new Coomera Hospital (u/c), Olympic-corridor investment | Fastest-growing; Goodlife + World Gym present |
| Pimpama | ~24,600 residents; among Australia's fastest-growing suburbs (3%+ p.a. corridor growth) | Future demand pipeline |
| Paradise Point / Runaway Bay / Hollywell | Affluent coastal strip | Premium demand, weak premium supply |
| Sanctuary Cove | Resort/golf estate, Country Club from $20.50/wk | Premium but members-club style, limited gym floor |

`[ASSUMPTION]` 10-minute drive-time population from the western gateway site ≈ **65,000–75,000** and growing >3% p.a.; to be confirmed with a purchased drive-time/catchment report (e.g. Location IQ / GapMaps) during DD. At 15% membership penetration that is ~10,000–11,000 current gym memberships inside 10 minutes, growing by ~350–450/year on population growth alone.

### 3.3 Infrastructure inflection (why *now*)

1. **Coomera Connector (M9) Stage 1 North opened 2 Dec 2025** (Shipper Dr, Coomera → Helensvale Rd) — a second north-south motorway immediately west of Hope Island; Central/South packages follow. (TMR)
2. **Hope Island rail station opened 18 May 2026**, off Hope Island Road next to Mangrove Jack Park, serving Hope Island/Helensvale/Oxenford (Cross River Rail / Translink).
3. **Hope Island Road carries ~30,878 vehicles/day** (bi-directional AADT, TMR TARS 2020 — pre-Connector; current volumes to be re-verified but corridor exposure is proven).
4. Northern corridor pipeline: Westfield Coomera ($470m, trading), Gold Coast Marine Precinct expansion ($400m), Coomera Hospital, Hope Island Town Centre DA (~18,700m² retail CBD for Hope Island next to the Hope Island Tavern), 2032 Olympics corridor spending.

---

## 4. Candidate sites

A live sweep of commercialrealestate.com.au, developmentready.com.au and commercialproperty2sell (July 2026) shows ~29 commercial listings and 7 land/development listings in 4212, plus corridor opportunities in Oxenford/Coomera. Listings churn weekly — final acquisition requires an agent-led off-market sweep. The five strategic options:
...
Weights reflect a destination flagship (members drive 10–15 min to a destination club; daily-needs co-location matters less than for a supermarket).

| Criterion | Wt | A: Town Centre | B: Western Gateway | C: HAVEN | D: Coomera | E: Oxenford |
|---|---|---|---|---|---|---|
| Catchment affluence / premium fit | 15% | 9 | 8 | 9 | 6 | 6 |
| Catchment size & growth (10 min) | 15% | 7 | 9 | 6 | 10 | 8 |
| Exposure & traffic | 12% | 6 | 10 | 4 | 8 | 7 |
| Site availability & size (4,500–7,000m² GFA + parking) | 12% | 5 | 8 | 3 | 6 | 8 |
| Planning pathway risk | 10% | 6 | 7 | 8 | 6 | 7 |
| Competitive insulation | 10% | 8 | 8 | 8 | 3 | 6 |
...
## 6. Named-anchor proximity audit (Site B)

| Anchor | Distance (approx.) |
|---|---|
| Hope Island rail station | 0–800m (site-dependent) |
| M9 Coomera Connector (Helensvale Rd interchange) | ~3–4 km |
| Westfield Helensvale + G:link terminus | ~4 km |
| Hope Island Marketplace (Woolworths/Aldi) | ~4 km east |
| Sanctuary Cove | ~6 km |
| Westfield Coomera | ~7 km |
| A.B. Paterson College, Helensvale SHS, Assisi College (schools) | 3–7 km |
| Hope Island golf courses (Links Hope Island, Sanctuary Cove x2) | 2–6 km |

`[ASSUMPTION]` Exact distances depend on the final lot; verify with a site-specific access study.
...
**Verdict: proceed on Site B corridor, with Site A as the disciplined fallback.**

---

## Sources

- [ABS 2021 Census QuickStats — Hope Island](https://abs.gov.au/census/find-census-data/quickstats/2021/SAL31356) · [AreaSearch Hope Island SA2](https://areasearch.com.au/qld/hope_island)
- [TMR TARS AADT segment report — road section 114](https://www.tmr.qld.gov.au/-/media/aboutus/corpinfo/Open-data/aadtsegmentreport/2020/aadtSegAndAnnualVolume-114-11413.pdf) · [QLD traffic census open data](https://www.data.qld.gov.au/dataset/traffic-census-for-the-queensland-state-declared-road-network)
- [Coomera Connector Stage 1 — TMR](https://www.tmr.qld.gov.au/projects/coomera-connector-stage-1) · [Opening statement, Dec 2025](https://statements.qld.gov.au/statements/104062)
- [Hope Island station — Cross River Rail](https://crossriverrail.qld.gov.au/stations-routes/gold-coast-line/hope-island-station/) · [Translink opening](https://translink.com.au/updates/1003816)
- [Hope Island Town Centre DA — MediaHunt](https://www.mediahunt.com.au/blog/hope-island-town-centre-set-become-reality) · [Hope Island Marketplace](https://www.hopeislandmarketplace.com.au/centre-info/)
- [Fitness Cartel clubs](https://www.fitnesscartel.com.au/clubs/) · [Merse Wellness Spa Coomera — Weekend Edition](https://www.indailyqld.com.au/theweekendedition-goldcoast/design/2026/06/03/merse-wellness-spa-coomera)
- [IBISWorld — Gyms & Fitness Centres in Australia](https://www.ibisworld.com/australia/industry/gyms-and-fitness-centres/658/) · [ASC — growth of the fitness industry](https://www.ausport.gov.au/participation/trends/growth-of-the-fitness-industry)
- [Pimpama growth](https://ironfish.com.au/blog-news/pimpama-queenslands-secret-suburb-with-over-20-population-growth/) · [Development Ready — Hope Island](https://www.developmentready.com.au/development-sites-for-sale/qld/hope-island-4212)
