...
The asset is underwritten three ways:
1. **Operating business** — 4,070 mature members at $36.10 blended weekly yield (38.5% EBITDAR margin), with the highest-margin lines (recovery, Pilates, allied health, café) matched to the catchment's actual demographics (median age 50, longevity-spending, daytime availability).
...
Five options were scored on a weighted matrix (catchment, growth, exposure, availability, planning, competition, cost, access, brand, portfolio fit — Phase 1). **The Hope Island Road western gateway corridor scored 8.3/10**, beating the Hope Island Town Centre precinct (6.6), Westfield Coomera fringe (6.2), HAVEN mixed-use (5.9) and Oxenford (7.0). It is the only location that captures both the island's wealth and the corridor's growth, with arterial exposure and full site control. **Fallback (pre-committed):** anchor pre-lease in the approved Hope Island Town Centre if a gateway parcel cannot be optioned within 9 months on terms.

We stress-tested "is Hope Island wrong?" — the honest answer is that a *discount box* on Hope Island would be wrong; a premium wellness precinct is the only format the data supports, and the south of the city is where that format is already contested.

## 5. Deal metrics (base case)

| | |
|---|---|
| Site | ~10,000m² freehold, gateway corridor |
| GFA / parking | 6,200m² / ~290 bays |
| Total development cost | **$47m** (Class 5, VE'd; $52.4m un-engineered) |
| Mature revenue / EBITDAR | $10.5m / **$4.05m (38.5%)** |
| Yield on cost | **8.6%** |
| PropCo lease | $2.3m p.a. triple-net, 15+5+5, 3% escalators |
| OpCo return | ~35% cash-on-cash on equipment capital |
| Levered project IRR (10yr) | **17–19%** (base), 25%+ upside |
| Break-even | ~2,450 members, month 14–18 |
| Members at maturity | 4,070 (74% of design capacity) |

## 6. Development timeline

| Milestone | Months from board approval |
|---|---|
| Site option secured, DD complete (flood study + TMR access are gating) | 0–6 |
| Unconditional + DA lodged (code assessable) | 7 |
| DA approval / detailed design / ECI tender | 12–14 |
| Construction start | 15 |
| Pre-sale launch (target 1,400 foundation members) | 24 |
| **Doors open** | **29–31** |
| Mature trading | 60 |

## 7. Principal risks & mitigations (full register in Phase 2–3 report)

| Risk | Mitigation |
|---|---|
| Flood/soft-soil site costs | Contract conditional on RPEQ flood study + geotech; freeboard designed in; piling base-cased in cost plan |
...
**Decision deadline logic:** every month of delay compounds three clocks — corridor land pricing (post-station), SEQ construction escalation, and competitor site-hunting. The window where you can buy the gateway before the market re-prices it is measured in quarters, not years.

---

## Package contents (Phase 10 deliverable index)

| Doc | Contents |
|---|---|
| `00-investment-memorandum.md` | This memorandum (Phases 8 & 10) |
| `07-financial-model.csv` | 10-year OpCo P&L model, spreadsheet-ready |
| `08-engagement-pack.md` | Cover letter, confidentiality & IP protocol, consultant procurement, data-room index |
| `01-location-analysis.md` | Catchment analytics, weighted 5-site scoring, honest counter-case (Phase 1) |
| `02-due-diligence.md` | Planning/flood/geotech/services/traffic DD framework, risk register, SWOT, acquisition score (Phases 2–3) |
| `03-facility-design.md` | 6,200m² area schedule, design standards, staging, 12-shot render brief (Phases 4–5) |
